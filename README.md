...
### Running Both Frontend and Backend (From root directory)
...
Widgets can only be added in registration currently. 
Widgets can be live updated by its device any time after registration.
